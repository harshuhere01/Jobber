...
class AllIdea extends StatefulWidget {
  const AllIdea({Key? key}) : super(key: key);

  @override
  State<AllIdea> createState() => _AllIdeaState();
}

class _AllIdeaState extends State<AllIdea> {
  @override
